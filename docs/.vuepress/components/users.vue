    ...
    export default {
        data() {
            return {
                users: [
                    {
                        name: "OpenEye Scientific Software",
                        logo: "https://www.eyesopen.com/hubfs/2016/07/openeye-logo.svg",
                        website: "https://www.eyesopen.com/"
                    },
                    {
                        name: "Legrand",
                        logo: "https://www.legrand.us/images/logo.png",
                        website: "https://www.legrand.us/"
                    },
                    {
                        name: "Milvus - Open Source Vector Similarity Search Engine",
